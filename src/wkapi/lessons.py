"""Script Filter: WaniKani lesson queue, one row per subject (live type-to-filter)."""
...
def main() -> None:
    ...
    try:
        ...
        subject_ids = available_subject_ids(summary["lessons"], now)
    ...
    emit(build_items(subject_ids, subjects_by_id, "🎉 No lessons available"))
